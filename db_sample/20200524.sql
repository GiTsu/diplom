...
INSERT INTO `answer_items` VALUES (1,8,7,10,'10'),(2,8,8,NULL,'[\"12\"]'),(3,8,9,NULL,'ответ изменен2'),(4,8,10,NULL,'{\"14\":\"15\"}');
...
INSERT INTO `groups` VALUES (2,'Тест группа');
...
INSERT INTO `question_items` VALUES (10,'ответ номер 1','1',NULL),(11,'выавыа',NULL,NULL),(12,'ывавыа',NULL,NULL),(13,'вавыавыавпмв','1',NULL),(14,'беларусь',NULL,15),(15,'Минск',NULL,NULL),(16,'fsdfds',NULL,NULL);
...
INSERT INTO `questions` VALUES (7,2,0,'вопрос 1 теста 1','текст вопроса 1 к тесту 1'),(8,2,1,'тест нескольких вариантов','вопрос с несколькими вариантами'),(9,2,2,'Тест ввода текста ответа','введите текст ответа'),(10,2,3,'тест соответствия','соотнесите страны и столицы'),(11,2,0,'sfdsfd','sfdfs'),(12,2,0,'fdgdfg','<!-- wp:paragraph -->\r\n<p>fgdf</p>\r\n<!-- /wp:paragraph -->'),(13,2,0,'okkp','<!-- wp:paragraph -->\r\n<p>lijljljkjk</p>\r\n<!-- /wp:paragraph -->'),(14,2,0,'fdsfds','<!-- wp:paragraph -->\r\n<p>dsfdsfdsf 12</p>\r\n<!-- /wp:paragraph -->');
...
INSERT INTO `rel_questions_items` VALUES (6,7,10),(7,8,11),(8,8,12),(9,8,13),(10,10,14),(11,10,15),(12,11,16);
...
INSERT INTO `rel_tests_questions` VALUES (9,5,8),(11,5,10),(15,5,9);
...
INSERT INTO `rel_users_tests` VALUES (5,10,5);
...
INSERT INTO `results` VALUES (8,5,10,'2020-05-05 12:49:51','2020-05-18 19:53:01',50,3);
...
INSERT INTO `role_user` VALUES (1,1,8,'2020-05-05 03:22:44','2020-05-05 03:22:44'),(2,2,9,'2020-05-05 03:35:03','2020-05-05 03:35:03'),(3,2,10,'2020-05-05 06:11:38','2020-05-05 06:11:38'),(4,1,10,'2020-05-14 09:16:52','2020-05-14 09:16:52');
...
INSERT INTO `tests` VALUES (5,'тест1',8,1,1,1,1,100,'описание тест1');
...
INSERT INTO `users` VALUES (8,'admin@diplom.test','admin@diplom.test',NULL,'$2y$10$uG5JppsJHJ2zvDhVqfeLpur3lCHjKzG4IEVjkCd/0tb3UHcFZKaj.','9MIoLvjcmS2ONzFkyi0FJh3aPqebvLa6f7RF2XaPfj3jHdDoTWpyWErDM7wd','2020-05-05 03:22:44','2020-05-24 16:47:47',2),(9,'student@diplom.test','student@diplom.test',NULL,'$2y$10$7iMdSWjV1Zq.7UX9XN23vuXAEEjxonvp1PQUJGW56dMERrPgwyv5C','1QPtzeAcgDfFg4m2HthrTVVJQNnT76fpcuQDJAfFUWbE0sWwpIiyuuIhRjFb','2020-05-05 03:34:51','2020-05-05 03:34:51',NULL),(10,'student1@diplom.test','student1@diplom.test',NULL,'$2y$10$qSBGOnZABzxIx84s20GFh.iPMo.mxMEdAB28M5crQZ1rf5CEyoHhu','uv78gBcjVPkpS32CLxJq09vjRoBRsZYbS4hwkYWpOo3H1dRkNQzYyDi1NgF7','2020-05-05 06:11:27','2020-05-05 06:11:27',NULL);
...
-- Dump completed on 2020-05-24 19:43:56
